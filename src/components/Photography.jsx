  ...
  return (
    <div className="photography">
      <div className="container">
        <div className="row align-items-center my-5 position-relative">
        <div className="col-lg-12">
          <h1 className="font-weight-light">My Photography</h1>
          <p></p>
        <hr></hr>
        </div>
          <div className="col-lg-6">
          <h2 className="font-weight-light">The Brooklyn Bridge</h2>
              <img
              ...
              <p className="m-2 text-center">
                Brooklyn Bridge, New York - January 2021
              </p>
          <h2 className="font-weight-light">The Manhattan Bridge</h2>
              <img
                className="img-fluid rounded mb-4 mb-lg-0"
              ...
              />
              <p className="m-2 text-center">
                DUMBO, Brooklyn, New York - January 2021
              </p>
          <h2 className="font-weight-light">Yellow Mountains<br></br>（黄山）</h2>
              <img
                className="img-fluid rounded mb-4 mb-lg-0"
              ...
              />
              <p className="m-2 text-center">
                Huangshan, Anhui Province, China - December 2019
              </p>
          <h2 className="font-weight-light">Huangshan City<br></br>（黄山市）</h2>
              <img
                className="img-fluid rounded mb-4 mb-lg-0"
              ...
              />
              <p className="m-2 text-center">
              Huangshan City, Anhui Province, China - December 2019
              </p>
          <h2 className="font-weight-light">Yellow Mountains<br></br>（黄山）</h2>
              <img
                className="img-fluid rounded mb-4 mb-lg-0"
          ...
          <h2 className="font-weight-light">Coney Island</h2>
              <img
                className="img-fluid rounded mb-4 mb-lg-0"
              ...
              />
              <p className="m-2 text-center">
                Coney Island, Brooklyn, New York - July 2018
              </p>
          <h2 className="font-weight-light">Times Square</h2>
              <img
                className="img-fluid rounded mb-4 mb-lg-0"
              ...
              />
              <p className="m-2 text-center">
                New York, New York - January 2018
              </p>
          <h2 className="font-weight-light">NYPL Central Library</h2>
              <img
                className="img-fluid rounded mb-4 mb-lg-0"
          ...
          <h2 className="font-weight-light">Lujiazui<br></br>（陆家嘴）</h2>
              <img
                className="img-fluid rounded mb-4 mb-lg-0"
              ...
              />
              <p className="m-2 text-center">
                Lujiazui, Shanghai, China - November 2019
              </p>
          ...
          <h2 className="font-weight-light">Renmin Rd.<br></br>（人民路）</h2>
              <img
                className="img-fluid rounded mb-4 mb-lg-0"
          ...
          <h2 className="font-weight-light">Welcome Sign</h2>
              ...
              />
              <p className="m-2 text-center">
                Brooklyn, New York - January 2021
              </p>
          <h2 className="font-weight-light">Yellow Mountains<br></br>（黄山）</h2>
              <img
                className="img-fluid rounded mb-4 mb-lg-0"
          ...
          <h2 className="font-weight-light">The Bund<br></br>（外滩）</h2>
              <img
                className="img-fluid rounded mb-4 mb-lg-0"
                src="https://live.staticflickr.com/65535/32783542407_cf39725bbc_c.jpg"
                alt=""
              />
              <p className="m-2 text-center">
                Shanghai, China - April 2019
          ...
          <h2 className="font-weight-light">Fuzhou<br></br>（福州）</h2>
              <img
                className="img-fluid rounded mb-4 mb-lg-0"
              ...
              />
              <p className="m-2 text-center">
                Fuzhou, Fujian Province, China - October 2019
              </p>
          <h2 className="font-weight-light">The Bund<br></br>（外滩）</h2>
              <img
                className="img-fluid rounded mb-4 mb-lg-0"
